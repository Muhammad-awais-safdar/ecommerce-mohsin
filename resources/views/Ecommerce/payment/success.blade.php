...
<div class="payment-success-container">
    <div class="payment-summary">
        ...
        <div class="payment-actions text-center relative">
            <!-- Download Button -->
            <button id="download-button"
                class="relative px-4 py-2 bg-blue-600 text-white font-semibold rounded-md shadow hover:bg-blue-700 transition">
                Download Receipt
            </button>

            <!-- Format Selection Popup -->
            <div id="format-popup"
                class="format-popup hidden absolute mt-2 w-52 bg-white shadow-lg rounded-md z-50 border border-gray-200 right-0">
                <a href="{{ route('order.receipt.download', ['order' => $order->id, 'format' => 'pdf']) }}"
                    class="block px-4 py-2 hover:bg-gray-100 text-gray-700">📄 Download as PDF</a>
                <a href="{{ route('order.receipt.download.img',  $order->id) }}"
                    class="block px-4 py-2 hover:bg-gray-100 text-gray-700">🖼️ Download as Image</a>
            </div>
        </div>
        <div class="payment-actions">
            <a href="{{ route('home') }}" class="button btn-return">Continue Shopping</a>
        </div>
    </div>
</div>
@endsection
