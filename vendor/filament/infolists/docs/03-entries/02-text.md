...
<AutoScreenshot name="infolists/entries/text/simple"loading="lazy" alt="Text entry" version="3.x" />
...
<AutoScreenshot name="infolists/entries/text/badge"loading="lazy" alt="Text entry as badge" version="3.x" />
...
<AutoScreenshot name="infolists/entries/text/list"loading="lazy" alt="Text entry with multiple values" version="3.x" />
...
<AutoScreenshot name="infolists/entries/text/bullet-list"loading="lazy" alt="Text entry with multiple values and bullet points" version="3.x" />
...
<AutoScreenshot name="infolists/entries/text/color"loading="lazy" alt="Text entry in the primary color" version="3.x" />
...
<AutoScreenshot name="infolists/entries/text/icon"loading="lazy" alt="Text entry with icon" version="3.x" />
...
<AutoScreenshot name="infolists/entries/text/icon-after"loading="lazy" alt="Text entry with icon after" version="3.x" />
...
<AutoScreenshot name="infolists/entries/text/icon-color"loading="lazy" alt="Text entry with icon in the primary color" version="3.x" />
...
<AutoScreenshot name="infolists/entries/text/large"loading="lazy" alt="Text entry in a large font size" version="3.x" />
...
<AutoScreenshot name="infolists/entries/text/bold"loading="lazy" alt="Text entry in a bold font" version="3.x" />
...
<AutoScreenshot name="infolists/entries/text/mono"loading="lazy" alt="Text entry in a monospaced font" version="3.x" />
...
<AutoScreenshot name="infolists/entries/text/copyable"loading="lazy" alt="Text entry with a button to copy it" version="3.x" />
