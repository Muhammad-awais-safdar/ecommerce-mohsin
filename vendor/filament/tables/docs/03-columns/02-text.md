...
<AutoScreenshot name="tables/columns/text/simple"loading="lazy" alt="Text column" version="3.x" />
...
<AutoScreenshot name="tables/columns/text/badge"loading="lazy" alt="Text column as badge" version="3.x" />
...
<AutoScreenshot name="tables/columns/text/description"loading="lazy" alt="Text column with description" version="3.x" />
...
<AutoScreenshot name="tables/columns/text/description-above"loading="lazy" alt="Text column with description above the content" version="3.x" />
...
<AutoScreenshot name="tables/columns/text/color"loading="lazy" alt="Text column in the primary color" version="3.x" />
...
<AutoScreenshot name="tables/columns/text/icon"loading="lazy" alt="Text column with icon" version="3.x" />
...
<AutoScreenshot name="tables/columns/text/icon-after"loading="lazy" alt="Text column with icon after" version="3.x" />
...
<AutoScreenshot name="tables/columns/text/icon-color"loading="lazy" alt="Text column with icon in the primary color" version="3.x" />
...
<AutoScreenshot name="tables/columns/text/large"loading="lazy" alt="Text column in a large font size" version="3.x" />
...
<AutoScreenshot name="tables/columns/text/bold"loading="lazy" alt="Text column in a bold font" version="3.x" />
...
<AutoScreenshot name="tables/columns/text/mono"loading="lazy" alt="Text column in a monospaced font" version="3.x" />
...
<AutoScreenshot name="tables/columns/text/copyable"loading="lazy" alt="Text column with a button to copy it" version="3.x" />
