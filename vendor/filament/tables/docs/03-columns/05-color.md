...
<AutoScreenshot name="tables/columns/color/simple"loading="lazy" alt="Color column" version="3.x" />
...
<AutoScreenshot name="tables/columns/color/copyable"loading="lazy" alt="Color column with a button to copy it" version="3.x" />
