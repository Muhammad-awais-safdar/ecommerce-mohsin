...
<AutoScreenshot name="tables/empty-state"loading="lazy" alt="Table with empty state" version="3.x" />
...
<AutoScreenshot name="tables/empty-state-heading"loading="lazy" alt="Table with customized empty state heading" version="3.x" />
...
<AutoScreenshot name="tables/empty-state-description"loading="lazy" alt="Table with empty state description" version="3.x" />
...
<AutoScreenshot name="tables/empty-state-icon"loading="lazy" alt="Table with customized empty state icon" version="3.x" />
...
<AutoScreenshot name="tables/empty-state-actions"loading="lazy" alt="Table with empty state actions" version="3.x" />
