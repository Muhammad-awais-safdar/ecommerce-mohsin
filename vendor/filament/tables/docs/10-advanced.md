...
<AutoScreenshot name="tables/reordering"loading="lazy" alt="Table with reorderable rows" version="3.x" />
...
<AutoScreenshot name="tables/reordering/custom-trigger-action"loading="lazy" alt="Table with reorderable rows and a custom trigger action" version="3.x" />
...
<AutoScreenshot name="tables/striped"loading="lazy" alt="Table with striped rows" version="3.x" />
